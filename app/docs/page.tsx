    ...
    <div className="min-h-screen pb-32 bg-black">
      ...
      <main className="container py-12 px-4 sm:px-6 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="bg-card/50 backdrop-blur-xl border border-border/50 p-6 hover-lift animate-slide-up">
            <Zap className="h-10 w-10 text-primary mb-4" />
            <h3 className="text-xl font-semibold mb-2">Getting Started</h3>
            <p className="text-muted-foreground mb-4">
              Learn the basics of USI and how to get started as an artist or listener.
            </p>
          ...
          <Card
            className="bg-card/50 backdrop-blur-xl border border-border/50 p-6 hover-lift animate-slide-up"
          ...
          >
            ...
            <p className="text-muted-foreground mb-4">Build integrations with the USI API.</p>
            <Button variant="link" className="p-0">
              View API →
            </Button>
          </Card>
