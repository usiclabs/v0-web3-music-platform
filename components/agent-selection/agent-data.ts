...
export const AGENTS: Agent[] = [
  ...
  },
  {
    ...
    description: "Creates trend-informed beats, instrumentals, and song briefs from research signals gathered by other agents.",
    category: "production",
    ovr: 89,
    power: 87,
    speed: 91,
    ...
    users: 19.6,
    active: true,
    skills: ["Trend-to-Beat Translation", "Suno Integration", "Beat Brief Generation"],
  },
]
