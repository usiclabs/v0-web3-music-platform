...
-- Artists can create their own stories
CREATE POLICY "Artists can create own stories"
  ON stories FOR INSERT
  WITH CHECK (artist_address = current_setting('request.jwt.claims', true)::json->>'sub');

-- Artists can update/delete own stories
